...
Tim, Gene, Kathryn
\begin{center} 
\textbf{A new class of exponential family measurement error models, with application to single-cell CRISPR screens}
\end{center}
