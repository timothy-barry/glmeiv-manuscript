...
$$D_2(\beta^g_1, c_\textrm{bayes}, 1/2) = 0.$$
...
% We prove that $\gamma$ is monotonic in $\beta_1^g$ for given $(\beta^g_0, c)$ and $\pi = 1/2$. Recall that
% $$\gamma(\beta^g_0, \beta^g_1, c, 1/2) = \frac{ g(\beta^g_1, c) }{ h(\beta^g_1, c)}.$$ By the quotient rule,
% $$D_2 \gamma (\beta^g_0, \beta^g_1, c, 1/2) = \frac{D_1 g( \beta^g_1, c) h(\beta^g_1, c) - g(\beta^1_g, c) D_1 h(\beta^g_1, c) }{ [ h(\beta^g_1, c)^2]}.$$ The derivative $D_1 g(\beta^g_1, c)$ of $g$ is 
% $$D_1 g(\beta^g_1, c) = f( \beta^g_0 + \beta^g_1 - c ).$$
