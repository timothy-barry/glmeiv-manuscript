...
% Overall, we show how coupling novel, principled statistical approaches to current, powerful technologies from genomics and computer science -- namely, CRISPR genome engineering, single-cell sequencing, cloud computing, and high-performance computing -- can drive new biological insights.
